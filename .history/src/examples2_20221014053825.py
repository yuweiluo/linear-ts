...
def example1_scenario(
    ...
    algs = {
        "TS-spec": Roful.spects(d, prior_var=prior_var, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4, alpha = 0.5, radius_oful=radius_SG ),
...
def run_single_experiment(d, k, t, g, l, state_factory, noise_sd=1.0, prior_var=1, thin_thresh=2.0, const_infl=5.0, delta = 0.1):
    ...
    algs = {
        "TS-spec": Roful.spects(d, prior_var=prior_var, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4, alpha = 0.8, radius_oful=radius_oful ),
        "TS-Bayes": Roful.ts(d, prior_var=prior_var, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4 ),
        "TS-Freq": Roful.ts(
            d,
            prior_var=prior_var,
        ...
        'oful': Roful.oful(d, alpha=alpha, radius_SG=radius_oful, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4 ),
        'greedy': Roful.greedy(d, prior_var=prior_var,  param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4 ),
    }
    if k == np.inf: 
        del algs['oful']
    else:
...
def russo_scenario(state_factory, k=1, d=100, t=1000, prior_var=2.0, arm_bound=0.1, prior_mu=0.0, noise_sd=1.0, thin_thresh=2.0, const_infl=5.0, radius=1.0):
    #prior_var = prior_var
    param = state_factory().normal(prior_mu, prior_var**0.5, d)
    ...
    algs = {
            "TS-Bayes": Roful.ts(d, prior_var=prior_var, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3 ),
        "TS-Freq": Roful.ts(
            d,
            prior_var=prior_var,
            state=state_factory(),
        ...
        'oful': Roful.oful(d, alpha=alpha, radius_SG=radius_oful, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3 ),
        'greedy': Roful.greedy(d, prior_var=prior_var,  param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3 ),
        }
        
    if k == np.inf: 
        del algs['oful', 'greedy']

    else:
        algs = {"TS-Bayes": Roful.ts(d, prior_var=prior_var, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3 ),}
        #"greedy": Roful.greedy(d, prior_var=prior_var, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 0.1 ),}
