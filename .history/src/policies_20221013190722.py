...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if self.tt == self.t:
            ...
            print(f"1/self.summary.scale = {1/self.summary.scale**0.5}, d = {weight_diff.T @ self.summary.xx @ weight_diff/beta**2}")
            print(f"weight_diff  = {weight_diff*self.summary.scale**0.5}")
