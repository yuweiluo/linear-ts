...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if zeta_square >= 0 :
            ...
            #print(f"opt_new = {opt_new}, 1/lambda_min = {1/lambda_min}")
            #print(f"wst_new = {wst_new}, 1/lambda_max = {1/lambda_max}")
        ...
        print(np.sqrt(wst_new/opt_new) -self.calculate_alpha )
        assert np.abs(np.sqrt(wst_new/opt_new) - self.calculate_alpha) < 0.001
