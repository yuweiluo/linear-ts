...
def run_experiments_d(
    ...
    output_name = f"dims-{d_min}-{d_max}-{d_gap}-gamma-{gamma}-prior_sd-{prior_sd}-noise_sd-{noise_sd}-radius-{radius}-sim-{sim}-k-{k}-t-{t}-prior_mu-{prior_mu}-thin_thresh-{thin_thresh}-const_infl-{const_infl}-n-{n}-time-{timestr}"
