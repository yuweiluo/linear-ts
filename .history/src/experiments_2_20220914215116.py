...
def __main__():
    ...
    if args.mode == 'd':
        ...
        run_experiments_gamma(n=args.n, d_min=args.d_min, d_max=args.d_max, d_gap=args.para_gap, k=args.k, t=args.t, s=args.s, prior_mu=args.pm, prior_sd=args.psd, noise_sd=args.nsd, thin_thresh=args.th, const_infl=args.inf, sim=args.sim, gamma=args.gamma, radius = args.radius)
