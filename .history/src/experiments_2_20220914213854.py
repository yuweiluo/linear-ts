...
def __main__():
    ...
    parser.add_argument("-para_min", type=int, help="parameter to simulate", default=50)
    parser.add_argument("-para_max", type=int, help="parameter to simulate", default=500)
    parser.add_argument("-para_gap", type=int, help="parameter to simulate", default=50)
