...
class DataSummary:
    ...
    def calculate_alpha(self):
        _, wst_x_XXinvnorm_sqr_TS = self.calculate_x_XXinvnorm_sqr_range(self.inflation(self), self.radius_TS())
        opt_x_XXinvnorm_sqr_RLS, _ = self.calculate_x_XXinvnorm_sqr_range(self.noise_sd, self.radius_det())
