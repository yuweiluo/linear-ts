...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        weight_theta_hat_upper =  weight_theta_hat + beta/ self.summary.scale ** 0.5 
        ...
        if self.tt == self.t:
            ...
            print(f"{theta_norm_upper_bound},{theta_norm_upper_bound_new},{theta_norm_upper_bound_new_new}")
