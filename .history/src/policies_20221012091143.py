...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if self.tt == self.t:
            ...
            print(f"newopt = {self.new_bound(lambda_max, lambda_min, self.x_XXnorm_min**2) }, opt_XX_norm! = {np.sqrt(theta_opt.T @ self.summary.xx @ theta_opt/ npl.norm(theta_opt)**2)}")
