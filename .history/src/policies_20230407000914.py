...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        self.outputs = ( self.approx_alpha, self.worst_alpha, self.oracle_regrets, self.metrics.regrets, self.thinnesses, self.errors, self.lambda_max, self.lambda_min,  self.proj_first,  self.betas, self.zeta)
