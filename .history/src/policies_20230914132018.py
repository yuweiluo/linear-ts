...
class SgTsWorthFunction(WorthFunction):
    ...
    def compute(self, ctx: Context) -> np.ndarray:
        #print(f'ctx.arms = {ctx.arms}, self.candidates() = {self.candidates()}')
        values = ctx.arms @ self.candidates()
        ...
        if discrete_mu < self.alpha:
            ...
            self.alpha_approx = alpha_approx
            #print("oful!")
            #print(f"inflation={self.summary.inflation(self.summary)},discrete_alpha =  {discrete_alpha}")
            #print(f"alpha_approx={self.alpha_approx},discrete_alpha =  {discrete_alpha}")
    ...
    def candidates(self):
        #print(f"self.summary.mean = {self.summary.mean},self.compensator = {self.compensator}")
        return self.summary.mean + self.compensator
