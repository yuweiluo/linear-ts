...
class Roful(Policy):
    ...
    def __init__(self, d, lambda, worth_func: WorthFunction,  param=None, noise_sd = None, t = None, radius = None, delta = None, inflation = None):
        super().__init__()
        ...
        self.summary = DataSummary(d, lambda, noise_sd, radius)
