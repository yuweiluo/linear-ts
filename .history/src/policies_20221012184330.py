...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if self.tt == self.t:
            ...
            print(f"lambda_min = {lambda_min},  lambda_2 = {self.summary.scale[1]} ,x_XXnorm_hat**2 = {theta_hat.T @ self.summary.xx @ theta_hat/ npl.norm(theta_hat)**2}, lambda_max = {self.summary.scale[0]} ")
