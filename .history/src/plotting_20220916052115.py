...
def plot_sample_path( df, x_name,  y_name, x_axis, y_axis,index_name_1, index_name_2,  save_path , normalized, x_lim = None):
        ...
        if index_1 >= 0:
            ...
            for index_2 in index_list_2:
                if index_2 >= 0:
                    ...
                    if y_name == 'TS-Bayes_errors' and np.max(mean)>10:
                        plt.ylim(0, 10)
...
def plot_statistics(output_folder_name, output_name, figure_folder_name, mode, normalized = 1, x_lim = 200):
    method_list = ['TS-Bayes_errors','TS-Bayes_lambda_mins', 'TS-Bayes_lambda_maxs','TS-Bayes_log_maxs_over_mins', 'TS-Bayes_thinnesses',  'TS-Bayes_lambdas_second', 'TS-Bayes_lambdas_third', 'TS-Bayes_lambdas_d_minus_1', 'TS-Bayes_lambdas_half_d', 'TS-Bayes_biases', 'TS-Bayes_variances','TS-Bayes_risks']
    ...
    for method in method_list:
        ...
        plot_sample_path(df, mode, method, 't', 'y', mode, 'k', f'{save_path}{method}-{output_name}', normalized, x_lim)
