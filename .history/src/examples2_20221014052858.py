...
def russo_scenario(
    state_factory, k=100, d=100, t=1000, prior_var=10.0, arm_bound=1,
    ...
    env = Environment(param, ctx_gen, noise_gen)
    algs = {
        "TS-Bayes": Roful.ts(d, prior_var=prior_var, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = 1 ),
        ...
        "TS-Freq": Roful.ts(
            ...
            state=state_factory(),
            inflation=Roful.radius_inflation(),
            param=param, noise_sd = noise_sd, t = t, radius = 1
        ),
        "TS-Improved": Roful.ts(
            d,
            prior_var=prior_var,
