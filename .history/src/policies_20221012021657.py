...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if self.tt == self.t:
            ...
            print(f"opt_XX_inv_norm = {np.sqrt(theta_opt.T @ self.summary.xx @ theta_opt/ npl.norm(theta_opt)**2)}, self.x_XXnorm_min= {self.x_XXnorm_min}, self.x_XXnorm_max = {self.x_XXnorm_max},1/opt_XX_inv_norm = {1/opt_XX_inv_norm} ")
