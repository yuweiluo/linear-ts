...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if self.tt == self.t:
            ...
            print(f"weight_theta_hat = {np.array(self.summary.basis)@np.array(theta_hat) @  self.summary.basis }, thetahat =  {weight_theta_hat**0.5 * npl.norm(theta_hat) @  self.summary.basis   },thetahat_true = {theta_hat} ")
