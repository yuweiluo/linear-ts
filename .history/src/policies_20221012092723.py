...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if self.tt == self.t:
            ...
            print(f"newopt = {self.new_bound(lambda_max, lambda_min, self.x_XXnorm_min**2) }, opt_XX_inv_norm = {opt_XX_inv_norm}")
    ...
    def new_bound (lambda_max, lambda_min, XX_norm_sqr):
        print(f"lambda_max = {lambda_max}, lambda_min = {lambda_min}, XX_norm_sqr = {XX_norm_sqr}")
        print(f"wtf == {1/lambda_max + 1/lambda_min - XX_norm_sqr/lambda_min/lambda_min}")
