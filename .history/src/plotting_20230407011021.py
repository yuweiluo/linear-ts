...
def plot_statistics(output_folder_name, output_name, figure_folder_name, mode,  gamma = None):
    ...
    attributes  = ['errors', 'regret','cumregret','approx_alphas','oracle_alphas' ,'worst_alphas' ,'lambda_mins', 'lambda_maxs','lambda_maxs_over_mins','projs_first', 'thinnesses',  'betas', 'zetas']
