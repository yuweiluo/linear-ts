...
# PYTHONPATH=src python -m emp1 -sim 5 -k 0 -para_min 150 -para_max 150 -para_gap 20 -pm 0 -nsd 0.2 -n 1 -mode "d" -gamma 0.1 -psd 0.1 -radius 5 -s 1 -alpha 8.0 -dataset 'cardiotocography' 

# PYTHONPATH=src python -m emp1 -sim 5 -k 0 -para_min 500 -para_max 500 -para_gap 20 -pm 0 -nsd 0.0 -n 10 -mode "d" -gamma 0.1 -psd 0.1 -radius 5 -s 1 -alpha 4.0 -dataset 'eeg'