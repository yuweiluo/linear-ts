...
def russo_scenario(state_factory, k=1, d=100, t=1000, prior_var=2.0, arm_bound=0.1, prior_mu=0.0, noise_sd=1.0, thin_thresh=2.0, const_infl=5.0, radius=1.0, alpha = 0.5):
    #prior_var = prior_var
    param = state_factory().normal(prior_mu, prior_var**0.5, d) + 10
    prior_var_ts_mis = prior_var
    ...
    algs = {
            "TS-AO": Roful.spects(d, prior_var=prior_var_ts_mis, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3, alpha = alpha, radius_oful=radius_oful ),
            "TS": Roful.ts(d, prior_var=prior_var_ts_mis, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3 ),
        "TS-Freq": Roful.ts(
            d,
            prior_var=prior_var_ts_mis,
            state=state_factory(),
            inflation=Roful.radius_inflation(),
            param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3
        ),
