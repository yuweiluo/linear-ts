...
def plot_statistics(output_folder_name, output_name, figure_folder_name, mode,  x_lim = None):
    ...
    for method in method_list:
        ...
        plot_sample_path(df, mode, method, 't', 'y', mode, 'k', f'{save_path}{method}-{output_name}', x_lim)
