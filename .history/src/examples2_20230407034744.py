...
def example2_scenario(
    ...
    algs = {
        "TS-MA": Roful.spects(d, lambda_=lambda_, state=state_factory(), inflation=noise_sd, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4, alpha =alpha, radius_oful=Roful.radius_inflation() ),
        "TS": Roful.ts(d, lambda_=lambda_, state=state_factory(), inflation=noise_sd, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4 ),
        # "OFUL": Roful.oful(
        #    d,
        #    alpha = 1,
        ...
        'OFUL': Roful.oful(d, lambda_=lambda_, radius_SG=Roful.radius_inflation(), param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4 ),
...
def example1_scenario(
    ...
    algs = {
        #"TS-MA2": Roful.spects(d, lambda_=lambda_, state=state_factory(), inflation=noise_sd, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4, alpha =alpha, radius_oful=Roful.radius_inflation() ),
        "TS-MA": Roful.spects(d, lambda_=lambda_, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4, alpha =alpha, radius_oful=Roful.radius_inflation() ),
        "TS": Roful.ts(d, lambda_=lambda_, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4 ),
        "TS-Freq": Roful.ts(
            d,
            lambda_=lambda_,
            state=state_factory(),
...
def run_single_experiment(d, k, t, g, l, state_factory, noise_sd=1.0, prior_var=1, thin_thresh=2.0, const_infl=5.0, delta = 0.1, alpha = 0.5):
    ...
    algs = {
        "TS-MA": Roful.spects(d, lambda_=lambda_, state=state_factory(), inflation=noise_sd, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3, alpha = alpha, radius_oful=Roful.radius_inflation() ),
        "TS": Roful.ts(d, lambda_=lambda_, state=state_factory(), inflation=noise_sd, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3 ),
        "TS-Freq": Roful.ts(
            d,
            lambda_=lambda_,
            state=state_factory(),
...
def russo_scenario(state_factory, k=1, d=100, t=1000, prior_var=2.0, arm_bound=0.1, prior_mu=0.0, noise_sd=1.0, thin_thresh=2.0, const_infl=5.0, radius=1.0, alpha = 0.5):
    ...
    algs = {
            "TS": Roful.ts(d, lambda_=lambda_, state=state_factory(), inflation=noise_sd, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3 ),
            "TS-Freq": Roful.ts(d,lambda_=lambda_,state=state_factory(),inflation=Roful.radius_inflation(),param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3),
            'OFUL': Roful.oful(d, lambda_=lambda_, radius_SG=Roful.radius_inflation(), param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3 ),
            "TS-MA": Roful.spects(d, lambda_=lambda_, state=state_factory(), inflation=noise_sd, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3, alpha = alpha, radius_oful=Roful.radius_inflation() ),
        }
