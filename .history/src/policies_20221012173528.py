...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if zeta_square >= 0 and theta_norm_lower_bound>0:
            ...
            opt_new_old, wst_new_old = self.new_bound(self.summary.scale, np.maximum(self.x_XXnorm_min**2,lambda_min), np.minimum( self.x_XXnorm_max_new**2,lambda_max))
        ...
        if self.tt == self.t:
            ...
            print(f"lambda_min = {lambda_min},  self.x_XXnorm_min**2 = {self.x_XXnorm_min** 2},   self.x_XXnorm_max_new**2 = {self.x_XXnorm_max_new**2},lambda_max = {lambda_max} ")
