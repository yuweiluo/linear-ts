...
def plot_statistics(output_folder_name, output_name, figure_folder_name, mode,  gamma = None):
    ...
    #method_list  = ['TS-Bayes_'+atti for atti in attributes] + ['TS-Freq_'+atti for atti in attributes] + ['TS-Improved_'+atti for atti in attributes] 
    method_list  = ['TS-Bayes_'+atti for atti in attributes] 
