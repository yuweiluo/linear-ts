...
def plot_statistics(output_folder_name, output_name, figure_folder_name, mode,  gamma = None):
    ...
    attributes  = ['errors', 'regret','cumregret','approx_alphas','lambda_mins', 'lambda_maxs','projs_first', 'thinnesses', 'biases', 'variances','risks', 'betas', 'zedas']
    method_list  = ['TS-Bayes_'+atti for atti in attributes] + ['greedy_'+atti for atti in attributes] + ['TS-ThinnessDirected_'+atti for atti in attributes] + ['TS-Thinness_'+atti for atti in attributes]
    method_list = ['TS-Bayes_errors',   'TS-Bayes_o_regret', 'TS-Bayes_o_cumregret','TS-Bayes_regret',  'TS-Bayes_regret','TS-Bayes_cumregret','TS-Bayes_lambda_mins', 'TS-Bayes_lambda_maxs','TS-Bayes_lambda_maxs_over_mins' ,'TS-Bayes_projs_first', 'TS-Bayes_thinnesses',  'TS-Bayes_alphas',  'TS-Bayes_approx_alphas', 'TS-Bayes_betas', 'TS-Bayes_zetas']
