...
# PYTHONPATH=src python -m experiments2 -sim 2 -k 3 -para_min 30 -para_max 30 -para_gap 10 -pm 10 -nsd 1 -n 20 -mode "d" -gamma 0.01 -psd 1 -s 1 -alpha 0.8

# PYTHONPATH=src python -m experiments2 -sim 1 -k 3 -para_min 100 -para_max 100 -para_gap 10 -pm 0 -nsd 1 -n 10 -mode "d" -gamma 0.1 -psd 1 -radius 10 -s 1 -alpha 0.8