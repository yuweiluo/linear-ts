...
def run_experiments_d(
    ...
    for d in d_list:
        ...
        for k in k_list:
            ...
            oracle_alphas = defaultdict(MetricAggregator)
            ...
            for i in range(n):
                ...
                for name, ( approx_alpha, oracle_alpha, worst_alpha, regret, thinness, error, lambda_max, lambda_min, proj_first,beta,beta_TS) in results.items():
                    ...
                    oracle_alphas[name].aggregate(oracle_alpha)
            ...
            if name == "cumregret":   for name, metric in metrics.items():
                plt.clf()
                marker_index = 0
                max_mean = []
                for alg, agg in metric.items():
                ...
                plt.ylim(0, np.min(5000, max(max_mean)))
...
## PYTHONPATH=src python -m experiments2 -sim 1 -k 10 -para_min 5 -para_max 5 -para_gap 10 -pm 0 -nsd 2 -n 5 -mode "d" -gamma 0.1 -psd 1 -radius 10 -s 1
...
## PYTHONPATH=src python -m experiments2 -sim 2 -k 0 -para_min 30 -para_max 30 -para_gap 10 -pm 0 -nsd 1 -n 20 -mode "d" -gamma 0.01 -psd 1 -s 1s
...
## PYTHONPATH=src python -m experiments2 -sim 1 -k 10 -para_min 90 -para_max 90 -para_gap 10 -pm 0 -nsd 1 -n 20 -mode "d" -gamma 0.1 -psd 1 -radius 10 -s 1 -alpha 1

# PYTHONPATH=src python -m experiments2 -sim 1 -k 10 -para_min 10 -para_max 10 -para_gap 10 -pm 0 -nsd 1 -n 10 -mode "d" -gamma 0.1 -psd 1 -radius 10 -s 1 -alpha 1

# PYTHONPATH=src python -m experiments2 -sim 1 -k 3 -para_min 10 -para_max 10 -para_gap 10 -pm 0 -nsd 1 -n 10 -mode "d" -gamma 0.1 -psd 1 -radius 10 -s 1 -alpha 0.9

# PYTHONPATH=src python -m experiments2 -sim 2 -k 3 -para_min 30 -para_max 30 -para_gap 10 -pm 10 -nsd 1 -n 20 -mode "d" -gamma 0.01 -psd 1 -s 1 -alpha 0.9

## Apr 27
# PYTHONPATH=src python -m experiments2 -sim 0 -k 0 -para_min 30 -para_max 30 -para_gap 20 -pm 0 -nsd 1 -n 20 -mode "d" -gamma 0.002 -psd 10 -radius 10 -s 1 -alpha 0.5

# PYTHONPATH=src python -m experiments2 -sim 2 -k 3 -para_min 30 -para_max 30 -para_gap 10 -pm 10 -nsd 1 -n 20 -mode "d" -gamma 0.1 -psd 1 -s 1 -alpha 0.5

# PYTHONPATH=src python -m experiments2 -sim 1 -k 3 -para_min 100 -para_max 100 -para_gap 10 -pm 0 -nsd 10 -n 20 -mode "d" -gamma 0.01 -psd 1 -radius 10 -s 1 -alpha 0.5

## May 4
# PYTHONPATH=src python -m experiments2 -sim 1 -k 3 -para_min 30 -para_max 30 -para_gap 10 -pm 0 -nsd 10 -n 50 -mode "d" -gamma 0.002 -psd 1 -radius 10 -s 1 -alpha 0.5
# PYTHONPATH=src python -m experiments2 -sim 2 -k 3 -para_min 30 -para_max 30 -para_gap 10 -pm 10 -nsd 1 -n 50 -mode "d" -gamma 0.1 -psd 1 -s 1 -alpha 0.5