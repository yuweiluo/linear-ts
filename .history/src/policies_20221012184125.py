...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if self.tt == self.t:
            ...
            print(f"lambda_min = {lambda_min},  self.x_XXnorm_min**2 = {self.x_XXnorm_min** 2},   self.x_XXnorm_max_new**2 = {self.x_XXnorm_max_new**2}, lambda_2 = {self.summary.scale[1]} ,x_XXnorm_hat**2 = {theta_hat.T @ self.summary.xx @ theta_hat/ npl.norm(theta_hat)**2}, lambda_max = {lambda_max} ")
