...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if self.tt == self.t:
            ...
            print(f"weight_theta_hat = {weight_theta_hat}, thetahat =  {np.array(self.summary.basis)@np.array(theta_hat) @  self.summary.basis   * npl.norm(theta_hat)},thetahat_true = {theta_hat} ")
