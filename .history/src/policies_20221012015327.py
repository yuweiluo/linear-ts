...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if zeta_square >= 0 and theta_norm_lower_bound>0:
            opt_XX_inv_norm,_ = self.solve_LP(self.summary.scale, self.x_XXnorm_min**2, self.x_XXnorm_max**2)
        ...
        if self.tt == self.t:
            ...
            print(f"self.x_XXnorm_min= {self.x_XXnorm_min}, self.x_XXnorm_max**2 = {self.x_XXnorm_max},1/opt_XX_inv_norm = {1/opt_XX_inv_norm} ")
