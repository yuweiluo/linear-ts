...
class Roful(Policy):
    ...
    def __init__(self, d, lambda_, worth_func: WorthFunction,  param=None, noise_sd = None, t = None, radius = None, delta = None, inflation = None):
        ...
        self.summary = DataSummary(d, lambda_, noise_sd, radius, param, inflation)
    ...
    def spects(d, lambda_, inflation=1.0, state=None, param=None, noise_sd = None, t = None, radius = None, delta = None, alpha = None, radius_oful = None):
        ...
        return Roful(d, lambda_, SgTsWorthFunction(inflation, alpha = alpha,  state=state), param, noise_sd = noise_sd, t = t,  radius = radius, delta = delta, inflation = inflation)
...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        self.outputs = ( self.worth_func.alphas, self.oracle_alpha, self.worst_alpha, self.metrics.regrets, self.thinnesses, self.errors, self.lambda_max, self.lambda_min,  self.proj_first,  self.betas, self.zeta)
...
class SgTsWorthFunction(WorthFunction):
    ...
    def compute(self, ctx: Context) -> np.ndarray:
        ...
        if alpha_approx > self.alpha:
            self.alphas.append(alpha_approx)
