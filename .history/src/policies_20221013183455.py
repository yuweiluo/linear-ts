...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if self.tt == self.t:
            ...
            print(f"weight_theta_hat = {weight_theta_hat}, thetahat =  {weight_theta_hat **0.5 @  self.summary.basis   * npl.norm(theta_hat)},thetahat_true = {theta_hat} ")
            print(f"weight_theta_hat**0.5 = {weight_theta_hat**0.5}, weight_theta_hat **0.5 =  {( np.array(self.summary.basis)@np.array(theta_hat))**2 / npl.norm(theta_hat)**2 } ")
