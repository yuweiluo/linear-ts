...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        weight_theta_hat =  ( np.array(self.summary.basis)@np.array(theta_hat)) / npl.norm(theta_hat)
        ...
        if self.tt == self.t:
            ...
            print(f"weight_theta_hat**2 = {np.sum(weight_theta_hat**2)}, thetahat =  {weight_theta_hat  @  self.summary.basis  @ npl.norm(weight_theta_hat) },thetahat_true = {theta_hat} ")
