    ...
    for d in d_list:
        ...
        for k in k_list:
            ...
            for i in range(n):
                ...
                for name, ( approx_alpha, mu, worst_alpha, regret, thinness, error, lambda_max, lambda_min, proj_first,beta,beta_TS) in results.items():
