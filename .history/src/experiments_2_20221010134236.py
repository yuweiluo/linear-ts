    ...
    for d in d_list:
        ...
        for k in k_list:
            ...
            for i in range(n):
                ...
                for name, (regret, thinness, error, lambda_max, lambda_min, lambda_maxs_over_mins, proj_first, alpha, beta,zeta) in results.items():
            ...
            labels = {"regret": "Instantaneous Regret", "cumregret": "Cumulative Regret", "thinnesses": "Thinness", "errors": "Normalized Error", "lambda_maxs": "Maximal Eigenvalues", "lambda_mins": "Minimal Eigenvalues", "log_maxs_over_mins": "Log Max / Min", "lambdas_second": "Second Largest Eigenvalues", "lambdas_third": "Third Largest Eigenvalues", "biases": "Biases", "variances": "Variances", "risks": "Risks", "lambdas_d_minus_1": "d-1 Largest Eigenvalues", "lambdas_half_d": "d/2 Largest Eigenvalues", "projs_first": "Projection onto first eigenspace", "errors_candidate": "Normalized Error of Candidate", "errors_pcandidate": "Normalized Error of P-Candidate", "alphas": "Alpha", "betas": "Beta", "zetas": "Zeta"}
