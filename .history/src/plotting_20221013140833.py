...
def plot_statistics(output_folder_name, output_name, figure_folder_name, mode,  gamma = None):
    ...
    attributes  = ['errors', 'regret','cumregret','approx_alphas','worst_alphas' ,'lambda_mins', 'lambda_maxs','TS-Bayes_lambda_maxs_over_mins','projs_first', 'thinnesses',  'betas', 'zedas']
    method_list  = ['TS-Bayes_'+atti for atti in attributes] + ['TS-Freq'+atti for atti in attributes] + ['TS-Improved_'+atti for atti in attributes] 
