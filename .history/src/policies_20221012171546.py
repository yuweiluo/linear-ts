...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        x_XXnorm_max_new = np.sqrt(theta_hat.T @ self.summary.xx**2  @ theta_hat)/zeta
        print(f"x_XXnorm_min = {self.x_XXnorm_min},x_XXnorm_max_new = {x_XXnorm_max_new}, x_XXnorm_max = {self.x_XXnorm_max}, sqrt_lambda_max = {np.sqrt(lambda_max)}")
