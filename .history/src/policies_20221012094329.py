...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if self.tt == self.t:
            ...
            print(f"opt_new = {opt_new}, wst_new = {wst_new}, opt_XX_inv_norm**2 = {opt_XX_inv_norm**2}, self.x_XXinvnorm_min**2 = {self.x_XXinvnorm_min**2}, self.x_XXinvnorm_max**2 = {self.x_XXinvnorm_max**2}")
