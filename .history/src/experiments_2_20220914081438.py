...
def __main__():
    ...
    parser.add_argument("-norm", type=float, help="norm of beta", default=1.0)
    ...
    if args.mode == 0:
        ...
        run_experiments_prior_sd(n=args.n, d_min=args.d_min, d_max=args.d_max, d_gap=args.d_gap, k=args.k, t=args.t, s=args.s, prior_mu=args.pm, prior_sd=args.psd, noise_sd=args.nsd, thin_thresh=args.th, const_infl=args.inf, sim=args.sim, gamma=args.gamma, beta_norm = args.norm)
