...
def example2_scenario(
    ...
    algs = {
        "TS-MA": Roful.spects(d, prior_var=prior_var, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4, alpha =alpha, radius_oful=Roful.radius_inflation() ),
        ...
        'OFUL': Roful.oful(d, alpha=prior_var, radius_SG=Roful.radius_inflation(), param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-4 ),
        }
...
def russo_scenario(state_factory, k=1, d=100, t=1000, prior_var=2.0, arm_bound=0.1, prior_mu=0.0, noise_sd=1.0, thin_thresh=2.0, const_infl=5.0, radius=1.0, alpha = 0.5):
    ...
    algs = {
            ...
            'OFUL': Roful.oful(d, alpha=prior_var, radius_SG=Roful.radius_inflation(), param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3 ),
            "TS-MA": Roful.spects(d, lambda_=lambda_, state=state_factory(), inflation=1.0, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3, alpha = alpha, radius_oful=Roful.radius_inflation() ),
        }
