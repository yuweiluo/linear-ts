...
class Roful(Policy):
    ...
    def spects(d, prior_var, inflation=1.0, state=None, param=None, noise_sd = None, t = None, radius = None, delta = None, alpha = None, radius_oful = None, tolerance = None):
        ...
        return Roful(d, prior_var, SgTsWorthFunction(inflation, alpha = alpha, radius = radius, noise_sd = noise_sd, delta = delta,radius_oful, tolerance, state=state), param, noise_sd = noise_sd, t = t,  radius = radius, delta = delta, inflation = inflation)
