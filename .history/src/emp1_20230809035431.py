...
def __main__():
    ...
    parser.add_argument("-mu_TS", type=np.float64, help="ratio threshold for TS", default=0.5)
    parser.add_argument("-mu_Greedy", type=np.float64, help="ratio threshold for Greedy", default=0.5)
