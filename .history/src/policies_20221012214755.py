...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        if self.tt == self.t:
            ...
            print(f"beta = {beta}, zeta_square = {zeta_square}, self.summary.lambda_ = { self.noise_sd * np.sqrt(2 * np.log((self.summary.lambda_ + self.t)**(self.d/2)* self.summary.lambda_ ** ( self.d/2)/ self.delta  ))}")
