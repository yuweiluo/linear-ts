...
def example2_scenario(
    ...
    algs = {
        "TS-MA": Roful.spects(d, lambda_=lambda_, state=state_factory(), inflation=ts_inflation_alter, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3, alpha =alpha, radius_oful=Roful.radius_inflation() ),
        "TS": Roful.ts(d, lambda_=lambda_, state=state_factory(), inflation=ts_inflation_alter, param=param, noise_sd = noise_sd, t = t, radius = radius, delta = 1e-3 ),
        # "OFUL": Roful.oful(
        #    d,
        #    alpha = 1,
