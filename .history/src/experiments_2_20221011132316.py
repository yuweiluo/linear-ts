...
def run_experiments_d(
    ...
    k_list = np.array([1,10,100, 1000, 10000, np.inf])
    ...
    for d in d_list:
        ...
        for k in k_list:
            ...
            for i in range(n):
                ...
                for name, (o_rerget, regret, thinness, error, lambda_max, lambda_min, lambda_max_over_min, proj_first, alpha, approx_alpha, beta,zeta) in results.items():
