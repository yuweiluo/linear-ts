...
def run_experiments_d(
    ...
    for d in d_list:
        ...
        for k in k_list:
            ...
            beta_TS = defaultdict(MetricAggregator)
            ...
            for i in range(n):
                ...
                for name, ( approx_alpha, oracle_alpha, worst_alpha, regret, thinness, error, lambda_max, lambda_min, proj_first,beta,beta_TS) in results.items():
                    ...
                    beta_TS[name].aggregate(beta_TS)
...
## Apr 27
# PYTHONPATH=src python -m experiments2 -sim 0 -k 0 -para_min 30 -para_max 30 -para_gap 20 -pm 0 -nsd 1 -n 20 -mode "d" -gamma 0.002 -psd 10 -radius 10 -s 1 -alpha 0.8

# PYTHONPATH=src python -m experiments2 -sim 2 -k 3 -para_min 30 -para_max 30 -para_gap 10 -pm 10 -nsd 1 -n 20 -mode "d" -gamma 0.1 -psd 1 -s 1 -alpha 0.8

# PYTHONPATH=src python -m experiments2 -sim 1 -k 3 -para_min 100 -para_max 100 -para_gap 10 -pm 0 -nsd 10 -n 20 -mode "d" -gamma 0.01 -psd 1 -radius 10 -s 1 -alpha 0.8