...
def plot_statistics(output_folder_name, output_name, figure_folder_name, mode,  gamma = None):
    method_list = ['TS-Bayes_errors','TS-Bayes_lambda_mins', 'TS-Bayes_lambda_maxs','TS-Bayes_projs_first','TS-Bayes_log_maxs_over_mins', 'TS-Bayes_thinnesses',  'TS-Bayes_lambdas_second', 'TS-Bayes_lambdas_third', 'TS-Bayes_lambdas_d_minus_1', 'TS-Bayes_lambdas_half_d', 'TS-Bayes_biases', 'TS-Bayes_variances','TS-Bayes_risks']
