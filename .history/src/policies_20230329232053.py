...
class Roful(Policy):
    ...
    def __init__(self, d, prior_var, worth_func: WorthFunction,  param=None, noise_sd = None, t = None, param_bound = None, delta = None, inflation = None):
        super().__init__()
        ...
        self.summary = DataSummary(d, prior_var, param_bound)
...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        self.beta = beta
        self.summary.radius_det()
        print(f"tt= {self.tt}, beta = {beta}, radius = {self.summary.radius_det()}")
