...
###########Yuwei##########################
    ...
    def update_metrics(self, feedback: Feedback):
        ...
        self.beta_TS = self.inflation(self.summary) * np.sqrt(2*self.d*np.log(2*self.d/self.delta*2*self.t))
        self.betas_TS.append(self.beta_TS)
